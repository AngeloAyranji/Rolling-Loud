  ...
  return (
    <div style={{ perspective: 2000 }}>
      <motion.div
        ...
        className="flex flex-col items-center md:items-start md:flex-row rounded-lg bg-[#121212] border-2 border-primary cursor-grab w-full max-w-[1260px] mb-10 drop-shadow-xl"
      >
