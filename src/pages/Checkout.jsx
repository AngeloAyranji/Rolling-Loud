      ...
      {!loadingCheckout ? (
        <Fragment>
          <div
            ...
            class={
              showToast
                ? "flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-red-500 rounded-lg shadow  fixed right-4 bottom-4 z-[10000]"
                : "hidden"
            }
            role="alert"
          >
            ...
            <div class="ml-3 text-sm font-normal text-secondary-content">
              Promo Code Expired
            </div>
            <button
              type="button"
              class="ml-auto -mx-1.5 -my-1.5 bg-transparent text-secondary-content hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 "
